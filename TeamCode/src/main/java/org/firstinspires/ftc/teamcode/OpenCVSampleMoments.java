...
@TeleOp
public class OpenCVSampleMoments extends LinearOpMode {
    ...
    public static class SamplePipeline extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {
            ...
            Imgproc.threshold(gray, thresholdMat, 182, 255, Imgproc.THRESH_BINARY_INV);
            ...
            // Compute the minimum-area rectangle for the largest and second-largest contours, if they exist
            if (secondLargestContour != null) {
                // Compute minimum-area rectangle
                RotatedRect minAreaRect = Imgproc.minAreaRect(new MatOfPoint2f(secondLargestContour.toArray()));
